...
export default function ThreadMessage({ taskName }) {
                ...
                <div className="appnavbar-scrollable-wrapper vertical-scrollable hide-scrollbar">
                    ...
                    <div className={`appnavbar-body ${bgclass}`}>
                        {parentMsg.map((item, index) => (
                            <MessageComp key={index} parentMsg={item} user={user} bgclass={bgclass} onQuote={onQuote} onClickTaskHandler={onClickTaskHandler} getParentMessage={getParentMessage} />
                        ))}
                        {threadMessage &&
