...
export default function GroupForms({ onClosehandler }) {
    ...
    try {
        return (
            <div className="tab-pane h-100 active" id="group-forms" role="tabpanel" aria-labelledby="group-forms-tab">
