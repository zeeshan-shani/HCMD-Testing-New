...
export const ChatSearch = ({
    userChatState, SetUserChatState, activeChat, user, setInspectUser, isPrivateChat
}) => {
    const isOpen = userChatState?.isSearchOpen?.isOpen;
    const type = userChatState?.isSearchOpen?.type ? userChatState.isSearchOpen.type : null;
    const searchType = Boolean(userChatState.isSearchOpen.searchType);
    const { taggedSearch } = useSelector(state => state.chat);
    ...
    const onClose = useCallback(() => SetUserChatState(prev => ({
        ...prev,
