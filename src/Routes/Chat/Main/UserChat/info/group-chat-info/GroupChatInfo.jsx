...
import { ArrowRightCircle, ArrowRightSquare, Pencil, PersonDash } from 'react-bootstrap-icons';
                        ...
                        <div className="container-fluid">
                            <ul className="nav justify-content-between align-items-center">
                                ...
                                <li className="nav-item list-inline-item">
                                    <div className="nav-link text-muted px-0" onClick={() => {
