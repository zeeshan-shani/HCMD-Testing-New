...
import { ListenTaskUpdate } from 'utils/wssConnection/Listeners/Tasklistener'
...
export default function UserTaskLogs() {
    ...
    useEffect(() => () => localStorage.setItem("taskAnalytics", JSON.stringify(showAnalytics)), [showAnalytics]);
