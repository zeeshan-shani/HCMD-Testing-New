...
import {
    ListenAddIssueSolution,
    ListenDeleteIssueComment,
    ListenUpdateIssue,
    ListenUpdateIssueSolution
...
export const AssignedRequestDetail = () => {
    ...
    useEffect(() => {
        ...
        ListenAddIssueSolution(requestData.id);
        ListenUpdateIssueSolution(requestData.id);
            ...
            return (<>
                <div className="issue-request-details text-color">
                    <div className="request-subject">
                        ...
                        <AssignedSolution requestData={requestData} user={user} />
