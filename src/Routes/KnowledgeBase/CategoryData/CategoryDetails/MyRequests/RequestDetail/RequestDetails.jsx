...
import { ReqUpdateIssue } from 'utils/wssConnection/Socket';
...
import {
    ListenDeleteIssueComment,
    ListenUpdateIssue,
    ListenUpdateIssueComment
} from 'utils/wssConnection/Listeners/IssuesListeners';
...
import AssignToUsers from 'Routes/KnowledgeBase/CategoryData/GenerateRequest/AssignToUsers';
...
export const RequestDetails = () => {
    ...
    useEffect(() => {
        ...
        ListenUpdateIssue(requestData.id);
        ListenUpdateIssueComment(requestData.id);
        ListenDeleteIssueComment();
    }, [requestData?.id]);
            ...
            return (<>
                <div className="issue-request-details text-color">
                    <div className="request-subject">
                            ...
                            <div className="px-1">
                                {format_subject &&
                                    <div className='d-flex'>
                                        {editMode ?
                                            <div className="align-items-center d-flex form-group m-0 w-100 mb-2">
                                            ...
                                            <h5 className='mb-1'>
                                                ...
                                                <span className='fs-16' dangerouslySetInnerHTML={{ __html: format_subject }}></span>
                                            </h5>
                                        }
                                    </div>}
                                ...
                                {subCategory &&
                                    <div className="d-flex">
                                        {!editMode ?
                                            ...
                                            :
                                            <AssignToUsers assignMembers={assignMembers} setAssignMem={setAssignMem} />
                                        }
                                    </div>}
                            </div>
                        ...
                        {subCategory &&
                            <RequestSolution requestData={requestData} user={user} />}
                        <RequestComments requestData={requestData} user={user} />
                    </div>
                </div>
            </>);
        } catch (error) {
